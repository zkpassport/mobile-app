...
public class ViewController: UIViewController {
  ...
  let videoDataOutputQueue = DispatchQueue(
    label: "com.example.apple-samplecode.VideoDataOutputQueue")
  ...
  public override func viewDidLoad() {
    ...
    // Hide cutout view by default (subclasses can show it if needed)
    cutoutView.isHidden = true
 ...
 public override func viewWillTransition(
  ...
  func setupOrientationAndTransform() {
    ...
    roiToGlobalTransform = CGAffineTransform(translationX: roi.origin.x, y: roi.origin.y).scaledBy(
    ...
    visionToAVFTransform = roiToGlobalTransform.concatenating(bottomToTopTransform).concatenating(
      uiRotationTransform)
  }
